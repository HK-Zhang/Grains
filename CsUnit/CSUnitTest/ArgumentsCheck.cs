...
namespace UnitTestTDD
{
    ...
    public class ArgumentsCheck
    {
        ...
        public void Test_ArgumentMatchers_IgnoringArguments()
        {
            ...
            calculator.Add(42, 5).ShouldBe(7);
            calculator.Add(123, 5).ShouldBe(7);
            calculator.Add(1, 7).ShouldNotBe(7);
        ...
        public void Test_ArgumentMatchers_ConditionallyMatchingThrowException()
        {
            ...
            formatter.Format("short").ShouldBe("matched");
            formatter.Format("not matched, too long").ShouldNotBe("matched");
            ...
            formatter.Format(null).ShouldNotBe("matched");
