...
namespace ConsoleApp.EfSql.Migrations
{
    ...
    [Migration("20180929010904_Inheritance3")]
    partial class Inheritance3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleApp.EfSql.Model.BlogR", b =>
                {
                    b.Property<int>("BlogRId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ConsoleApp.EfSql.Model.BlogS", b =>
                {
            ...
            modelBuilder.Entity("ConsoleApp.EfSql.Model.BlogT", b =>
                {
            ...
            modelBuilder.Entity("ConsoleApp.EfSql.Model.CarF", b =>
                {
                    b.Property<int>("CarFId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ConsoleApp.EfSql.Model.PostS", b =>
                {
            ...
            modelBuilder.Entity("ConsoleApp.EfSql.Model.RssBlogT", b =>
                {
                    b.HasBaseType("ConsoleApp.EfSql.Model.BlogT");
            ...
            modelBuilder.Entity("ConsoleApp.EfSql.Model.PostS", b =>
                {
                    b.HasOne("ConsoleApp.EfSql.Model.BlogS", "Blog")
                        .WithMany("Posts")
